  ...
  return (
    <div id="topbar" className="topBarContainer">
      ...
      <div className="topBar">
        <Link to="home" smooth duration={800} className="homeLink">
          Home
        </Link>
        {state.darkTheme ? (
          <button className="toggleLightButton" onClick={handleClick}>
            <i className="fa-solid fa-sun "></i>
          </button>
        ) : (
          <button id="dark" className="toggleDarkButton" onClick={handleClick}>
